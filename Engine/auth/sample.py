...
detector = cv2.CascadeClassifier("Savi\\Engine\\auth\\haarcascade_frontalface_default.xml")
...
count = 0 #---------------- Initializing sampling face count to 0 ----------------#
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("Savi/Engine/auth/samples/face." + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
